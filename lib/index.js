...
class FFDrawer {
  ...
  /**
   * @param {{ text: string, x: number, y: number, font?: string, size: string, color?: string, align?:  "start" | "center" | "end" | { x: "start" | "center" | "end", y: "start" | "center" | "end" } | "start" | "center" | "end", background?: { color: string, width: string|number }, shadow?: { color: string, x: number, y: number } }} param0 
   */
