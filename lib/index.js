...
class FFDrawer {
  ...
  /**
   * @param {{ text: string, x: number, y: number, width?: number, height?: number, align?: { x: "start" | "center" | "end", y: "start" | "center" | "end" } | "start" | "center" | "end" }} param0 
   */
  ...
  /**
   * @param {{ text: string, x: number, y: number, font?: string, color?: string, align?:  "start" | "center" | "end" | { x: "start" | "center" | "end", y: "start" | "center" | "end" } | "start" | "center" | "end", background?: { color: string, width: string|number }, shadow?: { color: string, x: number, y: number } }} param0 
   */
  drawText({ text, x, y, font, size, color, background, align, shadow }) {
    align = typeof align === "string" ? { x: align, y: align } : align;
    this.steps.push({
      type: "drawText",
      data: {
            ...
            filters.push(
              {
                ...
                options: {
                  ...
                  boxborderw: step.data.background?.width ?? 5,
