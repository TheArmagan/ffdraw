...
class FFDrawer {
  ...
  /**
   * @param {{ draw: (obj: { ctx: import("canvas").CanvasRenderingContext2D, canvas: import("canvas").Canvas, data: any }) => void | Promise<void>, x: number, y: number, width: number, height: number, data: any }} param0 
   * @returns {FFDrawer}
   */
